...
public class TipRecyclerViewFragment extends Fragment {
    private RecyclerView recyclerView;
    private TipItemAdapter itemAdapter;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    if(snapshot.getValue() instanceof List){
                        ...
                        hm.put(snapshot.getKey(), value.substring(0, value.length()-2));
                    } else
                ...
                for(Question q : questions){
                    ...
                    itemList.add(new TipItem(q.getId() + ": " + tip));
                }
